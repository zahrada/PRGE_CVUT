...
% % den1_1_1004_2.txt
% 1004 0          41.8323  4.010     %# orientacni osnova (posledni udaj: vod. delka) Pozn.: pasmo
% 1004 1          32.7153  6.979     %# orientacni osnova (posledni udaj: vod. delka) Pozn.: minihranol Leica
...
% 1002 0          393.2087 7.102   %  # orientacni osnova (posledni udaj: vod. delka)
% 1002 1          95.6767  3.572  %   # orientacni osnova (posledni udaj: vod. delka)
% 1002 1001        0.0000  0     %     # orientacni osnova
% 1002 1003       60.1333	 0	 %# orientacni osnova
% 1002 1004       75.2738  0     %     # orientacni osnova
% % den1_7_1001_2.txt
% 1001 0          0.0000   4.806    %# orientacni osnova (posledni udaj: vod. delka opravena o souctovou konstantu minihranolu)
% 1001 1          20.5617  6.867    %# orientacni osnova (posledni udaj: vod. delka opravena o souctovou konstantu minihranolu) 
...
% %den2_45_1001_1.txt
% 1001 0          0.0000    7.448  % # orientacni osnova (posledni udaj: vod. delka)
% 1001 1          24.0498   6.472  % # orientacni osnova (posledni udaj: vod. delka)
% 1001 1002      166.3238   0   %      # orientacni osnova 
% 1001 1004      106.6724   0     %    # orientacni osnova 
% 1001 1003      129.6742   0    %     # orientacni osnova 
% % den2_45_1002_2.txt
% 1002 0          0.0000    13.534   % # orientacni osnova (posledni udaj: vod. delka)
% 1002 1          32.8682   6.703   %  # orientacni osnova (posledni udaj: vod. delka)
% 1002 1001       9.4463    0       % # orientacni osnova
% 1002 1003       69.4816   0       %  # orientacni osnova 
% 1002 1004       84.6634   0      %   # orientacni osnova 
% % den2_45_1003_2.txt
% 1003 0          73.0797   4.8915   % # orientacni osnova (posledni udaj: vod. delka)
% 1003 1          16.8302   5.5855  %  # orientacni osnova (posledni udaj: vod. delka)
...
% % èárkou místo teèky
% 1004 0          144.3946  4.280     %# orientacni osnova 
% 1004 1           97.2151  4.270     %# orientacni osnova (posledni udaj: vod. delka)
% 1004 1001        65.0389  0		     %# orientacni osnova (posledni udaj: vod. delka)
% 1004 1002         0.0000  0         % # orientacni osnova
% 1004 1003        19.0833  0          %# orientacni osnova
% den3_2_1001_1.txt
1001 0          274.3113  2.758     %# orientacni osnova (posledni udaj: vod. delka) Pozn.: pasmo
1001 1          310.9620  3.406     %# orientacni osnova (posledni udaj: vod. delka) Pozn.: minihranol Leica    merena 3.423
1001 1002       59.6496   0         %# orientacni osnova 
1001 1003       23.0158   0         %# orientacni osnova
1001 1004        0.0000   0        % # orientacni osnova
% den3_2_1004_1.txt
1004 0           164.3112  2.618    % # orientacni osnova (posledni udaj: vod. delka)
1004 1           81.4224   2.502    % # orientacni osnova (posledni udaj: vod. delka)
1004 1001        65.0464   0        % # orientacni osnova 
1004 1002         0.0000   0       %  # orientacni osnova
1004 1003        19.0548   0        % # orientacni osnova
% den3_3_1002_1.txt
1002 0          385.7461  4.5187    %# orientacni osnova (posledni udaj: vod. delka)
1002 1          142.9770  4.3499     %# orientacni osnova (posledni udaj: vod. delka)
1002 1001         0.0000  0		    %# orientacni osnova 
1002 1003        60.1793  0         % # orientacni osnova
1002 1004        75.3049  0          %# orientacni osnova
% den3_3_1003_1.txt
1003 0            102.8593  5.708   %# orientacni osnova (posledni udaj: vod. delka)
1003 1            119.2801  9.850   %# orientacni osnova (posledni udaj: vod. delka)
...
% 1001 1002 1004   59.6528   59.6519   59.6534             %  # uhel byl meren pouze ve dvou lab. jednotkach
% % den2_45_1002_2.txt
