...
clear all
format long g
% blbnou kvadranty u azimutù nevím proè
...
o = [         1001    0        20.5617   6.867    % orientacni osnova (posledni udaj: vod. delka opravena o souctovou konstantu minihranolu) CENTR
              ...
              1003    0        26.0180   6.299    % orientacni osnova (posledni udaj: vod. delka - mìøeno na miniHRANOL Leica)  CENTR              
              1003    1       391.5348   4.545    % orientacni osnova (posledni udaj: vod. delka - mìøeno pásmem) EXCIL
...
%rameno 1002 - 1004 je asi špatnì
...
% %% 2. turnus skupina è.2 (1002 pøevzato od 2. turnus skupina è.1)
% % hodnoty z tabulek
...
for(i = 1:size(souradnice,1))
    ...
    fprintf('%5.0f - použitá meridiánová konvergence %2.0f° %2.0f'' %2.1f"\n',souradnice(i,1),c)
end 
